...
<div class="image-section">
   <div class="text">
     <p>
        These posters are made during the PLC course and were made in the application AdobePhotoshop using different techniques as: collage and drawing. Posters were made on Ukrainian Mythological theme.
     </p>
   </div>
</div>
