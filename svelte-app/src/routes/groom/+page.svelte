...
<div class="image-section">
   <div class="text">
     <p>
        This project was made in Adobe Illustration and Adobe InDesign applications for a potential grooming salon. There is a Logo, Poster, Broshure, Flyer, Business Card and design for a Note Pages. 
     </p>
   </div>
</div>
...
<style>
    ...
    .scrolling-bar {
      ...
      padding: 1rem ; /* Add some padding above and below the bar */
  ...
  @media (max-width: 768px) {
    .text-overlay {
      ...
      padding: 1.5rem;
      width: 300px; /* Make overlay wider on phones */
