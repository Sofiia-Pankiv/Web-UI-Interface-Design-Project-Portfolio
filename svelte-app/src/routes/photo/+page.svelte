...
<div class="image-section">
   <div class="text">
     <p>
        Photoes were taken in different locations in Ireland and eddited in Adobe Lightroom using different fillters and effects to make them more pleasant for the eye and grab attention of people.
     </p>
   </div>
</div>
