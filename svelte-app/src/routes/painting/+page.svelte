...
<div class="image-section">
   <div class="text">
     <p>
        Paintings which were created during the free time using Acrylic paintings and canvas. It actualy is pretty usefull for understanding how to work with colors.
     </p>
   </div>
</div>
